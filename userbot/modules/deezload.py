...
from userbot import CMD_HELP, DEEZER_ARL_TOKEN, TEMP_DOWNLOAD_DIRECTORY, trgg
from userbot.events import register
from userbot.utils.FastTelethon import upload_file


@register(outgoing=True, pattern="^\{trg}deez (.+?|) (FLAC|MP3\_320|MP3\_256|MP3\_128)".format(trg=trgg))
async def _(event):
