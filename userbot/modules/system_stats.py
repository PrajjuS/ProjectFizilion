...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"`-------------------------------------------------------------- `\n"
        f"**[OS Info]:**\n"
        f"__•Platform Type   : {os.name}__\n"
        f"__•Distro          : {distro.name(pretty=False)} {distro.version(pretty=False, best=False)}__\n"
        f"`--------------------------------------------------------------`\n"
        f"**[PYPI Module Versions]:**\n"
        f"__•Python         : v{python_version()}__`\n"   
        f"__•Telethon       : v{version.__version__}__`\n"
        f"__•PIP            : v{pip.__version__}__\n"
        f"`--------------------------------------------------------------`\n"
        f"**[MISC Info]:**\n"
        f"__•User           : {DEFAULTUSER}__\n"
        f"__•Running on     : {repo.active_branch.name}__\n"
        f"__•Loaded modules : {len(modules)}__\n"
        f"__•Fizilion       : {USERBOT_VERSION}__\n"
        f"__•Bot Uptime     : {uptime}__\n"
        f"`--------------------------------------------------------------`\n"
